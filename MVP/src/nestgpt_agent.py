...
MVP_DIR = SRC_DIR.parent
DATASET_DIR = MVP_DIR / "data"
MAX_DATASET_RECORDS = 6

HTML = (SRC_DIR / "app_template.html").read_text(encoding="utf-8")
...
def load_api_key() -> str:
    ...
    for key_path in (MVP_DIR / "APIKEY.txt", SRC_DIR / "APIKEY.txt"):
        if key_path.exists():
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        if self.path == "/logo.png":
            logo_path = SRC_DIR / "NestGPT-Logo.png"
